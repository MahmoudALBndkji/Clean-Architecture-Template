...
import 'package:clean_architecture_template/core/mixins/pagination_mixin.dart';
...
import 'package:clean_architecture_template/features/users/presentation/widgets/user_card.dart';
      ...
      listener: (context, state) {
        if (state.users.status.isFailure && state.users.error != null) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(state.users.error!)),
          );
        }
      },

...
import 'package:clean_architecture_template/features/favourite/presentation/widgets/favourite_card.dart';
        ...
        builder: (context, state) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              final user = state.favourites.data?[index] ?? DataEntity();
